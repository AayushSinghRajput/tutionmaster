    ...
    <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full">
      ...
      <div className="w-full">
        ...
        <input
          ...
          className={`w-full px-4 py-3 sm:px-5 sm:py-4 text-base sm:text-lg border-2 rounded-2xl shadow-sm focus:outline-none focus:ring-4 focus:ring-brand-200 focus:border-brand-500 transition-all duration-300 ${
            errors?.contact?.email || formErrors?.contact?.email ? "border-red-500 bg-red-50" : "border-brand-200 hover:border-brand-400"
          }`}
      ...
      <div className="w-full">
        ...
        <input
          ...
          className={`w-full px-4 py-3 sm:px-5 sm:py-4 text-base sm:text-lg border-2 rounded-2xl shadow-sm focus:outline-none focus:ring-4 focus:ring-brand-200 focus:border-brand-500 transition-all duration-300 ${
            errors?.contact?.phone || formErrors?.contact?.phone ? "border-red-500 bg-red-50" : "border-brand-200 hover:border-brand-400"
          }`}
