...
const ProfileReadyBanner = () => (
  <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-2xl p-5 sm:p-8 text-white text-center shadow-lg w-full">
    <Star className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-3 sm:mb-4" />
    <h3 className="font-bold text-xl sm:text-2xl mb-2 sm:mb-3">Ready to Complete Your Profile!</h3>
