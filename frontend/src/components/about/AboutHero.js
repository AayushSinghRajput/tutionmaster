...
const AboutHero = () => {
  return (
    <section className="relative py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-lg sm:text-xl text-blue-100 leading-relaxed mb-8 max-w-3xl mx-auto">
